                    ...
                    <>
                        ...
                        {showBehaviorFeatureCheckboxes && (
                            <>
                                ...
                                {(shouldShow('persistDraft') || shouldShow('largeTextPaste') || shouldShow('arrowKeyHistory') || (!isMobile && shouldShow('inputSpellcheck')) || shouldShow('enterToSend')) && (
                                <SettingsSection
