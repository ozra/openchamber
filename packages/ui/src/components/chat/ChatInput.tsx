...
const ChatInputComponent: React.FC<ChatInputProps> = ({
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
        ...
        // PRD-031 (fork): with "Enter sends" turned off, Ctrl/Cmd+Enter takes
        // over the role plain Enter had, so it must honor queue/steer like Enter
        // did. The send-now escalation moves up to Ctrl/Cmd+Shift+Enter rather
        // than being lost.
        const enterWritesNewline = enterToSendConfigured && !enterToSend;
        const sendNow = enterWritesNewline ? (isCtrlEnter && e.shiftKey) : isCtrlEnter;
