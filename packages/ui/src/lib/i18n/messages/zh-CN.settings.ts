...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': '向上滚动聊天记录',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': '向下滚动聊天记录',
  ...
  'settings.openchamber.visual.field.arrowKeyPromptHistoryAria': '方向键回忆之前的输入',
  'settings.openchamber.visual.field.arrowKeyPromptHistory': '方向键回忆之前的输入',
  'settings.openchamber.visual.field.arrowKeyPromptHistoryHint': '关闭后，方向键不会回忆之前的输入，而是像平时一样移动光标。',
  ...
  'settings.openchamber.sidebar.title': '侧边栏',
  'settings.openchamber.sidebar.tooltip': '执行操作后会话侧边栏的行为。',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': '隐藏顶部的“新建会话”按钮',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': '隐藏侧边栏顶部的“新建会话”按钮',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': '隐藏全局的“新建会话”按钮。之后改从项目标题或其菜单中选择新建会话。',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': '始终显示侧边栏操作图标',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': '始终显示侧边栏操作图标',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': '悬停时不再隐藏，而是以柔和的色调始终显示项目和分组的操作图标。',
