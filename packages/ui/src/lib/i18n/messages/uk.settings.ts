...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label": "Прокрутити історію чату вгору",
  "settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label": "Прокрутити історію чату вниз",
  ...
  "settings.openchamber.visual.field.arrowKeyPromptHistoryAria": "Стрілки згадують попередні повідомлення",
  "settings.openchamber.visual.field.arrowKeyPromptHistory": "Стрілки згадують попередні повідомлення",
  "settings.openchamber.visual.field.arrowKeyPromptHistoryHint": "Коли вимкнено, стрілки переміщують курсор як зазвичай, а не згадують попередні повідомлення.",
  ...
  "settings.openchamber.sidebar.title": "Бічна панель",
  "settings.openchamber.sidebar.tooltip": "Поведінка бічної панелі сеансів після виконання дії.",
  "settings.openchamber.sidebar.field.hideHeaderNewSession": "Сховати кнопку «Новий сеанс» у заголовку",
  "settings.openchamber.sidebar.field.hideHeaderNewSessionAria": "Сховати кнопку «Новий сеанс» у заголовку бічної панелі",
  "settings.openchamber.sidebar.field.hideHeaderNewSessionHint": "Ховає глобальну кнопку «Новий сеанс». Нові сеанси тепер запускаються із заголовка проєкту або його меню.",
  "settings.openchamber.sidebar.field.actionsAlwaysVisible": "Завжди показувати піктограми дій бічної панелі",
  "settings.openchamber.sidebar.field.actionsAlwaysVisibleAria": "Завжди показувати піктограми дій бічної панелі",
  "settings.openchamber.sidebar.field.actionsAlwaysVisibleHint": "Показує піктограми дій проєктів і груп у приглушеному тоні, а не лише під час наведення.",
