...
export const dict: Record<I18nKey, string> = {
  ...
  'quota.pace.aria.onPace': '{used}% 사용됨, 경과 시간과 같은 속도',
  'quota.pace.aria.aheadOne': '{used}% 사용됨, 경과 시간보다 1%포인트 앞섬',
  'quota.pace.aria.aheadMany': '{used}% 사용됨, 경과 시간보다 {delta}%포인트 앞섬',
  'quota.pace.aria.behindOne': '{used}% 사용됨, 경과 시간보다 1%포인트 뒤처짐',
  'quota.pace.aria.behindMany': '{used}% 사용됨, 경과 시간보다 {delta}%포인트 뒤처짐',
