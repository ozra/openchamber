...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': 'Faire défiler l’historique du chat vers le haut',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': 'Faire défiler l’historique du chat vers le bas',
  ...
  'settings.openchamber.visual.field.arrowKeyPromptHistoryAria': 'Les flèches rappellent les messages précédents',
  'settings.openchamber.visual.field.arrowKeyPromptHistory': 'Les flèches rappellent les messages précédents',
  'settings.openchamber.visual.field.arrowKeyPromptHistoryHint': 'Lorsque désactivé, les flèches déplacent le curseur comme d\'habitude au lieu de rappeler les messages précédents.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.openchamber.sidebar.title': 'Barre latérale',
  'settings.openchamber.sidebar.tooltip': 'Le comportement de la barre latérale des sessions après une action.',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': 'Masquer le bouton Nouvelle session de l\'en-tête',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': 'Masquer le bouton Nouvelle session de l\'en-tête de la barre latérale',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': 'Masque le bouton global Nouvelle session. Les nouvelles sessions se lancent alors depuis l\'en-tête du projet ou son menu.',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': 'Toujours afficher les icônes d\'action de la barre latérale',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': 'Toujours afficher les icônes d\'action de la barre latérale',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': 'Affiche les icônes d\'action des projets et des groupes en permanence dans un ton atténué, au lieu de les révéler au survol.',
