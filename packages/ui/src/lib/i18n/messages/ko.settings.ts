...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': '채팅 기록을 위로 스크롤',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': '채팅 기록을 아래로 스크롤',
  ...
  'settings.openchamber.keyboardShortcuts.action.zoom_reset.label': '확대/축소 재설정',
  ...
  'settings.openchamber.visual.field.arrowKeyPromptHistoryAria': '화살표 키로 이전 메시지 불러오기',
  'settings.openchamber.visual.field.arrowKeyPromptHistory': '화살표 키로 이전 메시지 불러오기',
  'settings.openchamber.visual.field.arrowKeyPromptHistoryHint': '끄면 화살표 키는 이전 메시지를 불러오지 않고 평소처럼 커서만 움직입니다.',
  ...
  'settings.openchamber.sidebar.title': '사이드바',
  'settings.openchamber.sidebar.tooltip': '작업 후 세션 사이드바가 동작하는 방식입니다.',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': '헤더의 새 세션 버튼 숨기기',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': '사이드바 헤더의 새 세션 버튼 숨기기',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': '전역 새 세션 버튼을 숨깁니다. 새 세션은 프로젝트 제목이나 해당 메뉴에서 시작하게 됩니다.',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': '사이드바 작업 아이콘 항상 표시',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': '사이드바 작업 아이콘 항상 표시',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': '프로젝트 및 그룹 작업 아이콘을 호버할 때만 표시하지 않고, 차분한 톤으로 항상 표시합니다.',
