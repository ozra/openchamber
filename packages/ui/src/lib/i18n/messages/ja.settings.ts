...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': 'チャット履歴を上にスクロール',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': 'チャット履歴を下にスクロール',
  'settings.openchamber.keyboardShortcuts.action.zoom_in.label': '拡大',
  ...
  'settings.openchamber.visual.field.arrowKeyPromptHistoryAria': '矢印キーで以前の入力を呼び出す',
  'settings.openchamber.visual.field.arrowKeyPromptHistory': '矢印キーで以前の入力を呼び出す',
  'settings.openchamber.visual.field.arrowKeyPromptHistoryHint': 'オフのとき、矢印キーは以前の入力を呼び出さず、カーソルだけを移動します。',
  ...
  'settings.openchamber.sidebar.title': 'サイドバー',
  'settings.openchamber.sidebar.tooltip': 'アクション実行後のセッションサイドバーの動作です。',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': 'ヘッダーの「新しいセッション」ボタンを非表示にする',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': 'サイドバーヘッダーの「新しいセッション」ボタンを非表示にする',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': 'グローバルな「新しいセッション」ボタンを非表示にします。新しいセッションはプロジェクトの見出しまたはそのメニューから開始します。',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': 'サイドバーのアクションアイコンを常に表示する',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': 'サイドバーのアクションアイコンを常に表示する',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': 'プロジェクトとグループのアクションアイコンを、ホバーで表示するのではなく控えめな色合いで常時表示します。',
