...
export const dict: Record<I18nKey, string> = {
  ...
  'quota.pace.aria.onPace': '{used} procent użycia, zgodnie z upływem czasu',
  'quota.pace.aria.aheadOne': '{used} procent użycia, 1 punkt procentowy przed upływem czasu',
  'quota.pace.aria.aheadMany': '{used} procent użycia, {delta} punktów procentowych przed upływem czasu',
  'quota.pace.aria.behindOne': '{used} procent użycia, 1 punkt procentowy za upływem czasu',
  'quota.pace.aria.behindMany': '{used} procent użycia, {delta} punktów procentowych za upływem czasu',
