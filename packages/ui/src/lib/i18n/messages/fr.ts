...
export const dict = {
  ...
  'quota.pace.aria.onPace': '{used} % utilisé, au rythme du temps écoulé',
  'quota.pace.aria.aheadOne': '{used} % utilisé, 1 point de pourcentage en avance sur le temps écoulé',
  'quota.pace.aria.aheadMany': '{used} % utilisé, {delta} points de pourcentage en avance sur le temps écoulé',
  'quota.pace.aria.behindOne': '{used} % utilisé, 1 point de pourcentage en retard sur le temps écoulé',
  'quota.pace.aria.behindMany': '{used} % utilisé, {delta} points de pourcentage en retard sur le temps écoulé',
