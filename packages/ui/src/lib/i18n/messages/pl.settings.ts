...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': 'Przewiń historię czatu w górę',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': 'Przewiń historię czatu w dół',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.openchamber.sidebar.title': 'Pasek boczny',
  'settings.openchamber.sidebar.tooltip': 'Zachowanie paska bocznego sesji po wykonaniu akcji.',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': 'Ukryj przycisk Nowa sesja w nagłówku',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': 'Ukryj przycisk Nowa sesja w nagłówku paska bocznego',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': 'Ukrywa globalny przycisk Nowa sesja. Nowe sesje uruchamiasz wtedy z nagłówka projektu lub jego menu.',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': 'Zawsze pokazuj ikony akcji paska bocznego',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': 'Zawsze pokazuj ikony akcji paska bocznego',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': 'Pokazuje ikony akcji projektów i grup w spokojnym tonie zamiast odsłaniać je po najechaniu.',
