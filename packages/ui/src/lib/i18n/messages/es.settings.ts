...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label": "Desplazar el historial del chat hacia arriba",
  "settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label": "Desplazar el historial del chat hacia abajo",
  ...
  "settings.openchamber.visual.field.arrowKeyPromptHistoryAria": "Las teclas de flecha recuerdan mensajes anteriores",
  "settings.openchamber.visual.field.arrowKeyPromptHistory": "Las teclas de flecha recuerdan mensajes anteriores",
  "settings.openchamber.visual.field.arrowKeyPromptHistoryHint": "Cuando está desactivado, las teclas de flecha mueven el cursor como siempre, en lugar de recordar mensajes anteriores.",
  ...
  "settings.openchamber.sidebar.tooltip": "Cómo se comporta la barra lateral de sesiones después de una acción.",
  "settings.openchamber.sidebar.field.hideHeaderNewSession": "Ocultar el botón Nueva sesión del encabezado",
  "settings.openchamber.sidebar.field.hideHeaderNewSessionAria": "Ocultar el botón Nueva sesión del encabezado de la barra lateral",
  "settings.openchamber.sidebar.field.hideHeaderNewSessionHint": "Oculta el botón global Nueva sesión. Las nuevas sesiones se inician entonces desde el encabezado del proyecto o su menú.",
  "settings.openchamber.sidebar.field.actionsAlwaysVisible": "Mostrar siempre los iconos de acción de la barra lateral",
  "settings.openchamber.sidebar.field.actionsAlwaysVisibleAria": "Mostrar siempre los iconos de acción de la barra lateral",
  "settings.openchamber.sidebar.field.actionsAlwaysVisibleHint": "Muestra los iconos de acción de proyectos y grupos en reposo con un tono atenuado, en lugar de revelarlos al pasar el cursor.",
