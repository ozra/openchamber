...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label": "Rolar o histórico do chat para cima",
  "settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label": "Rolar o histórico do chat para baixo",
  "settings.openchamber.keyboardShortcuts.action.zoom_in.label": "Ampliar",
  "settings.openchamber.keyboardShortcuts.action.zoom_out.label": "Reduzir",
  ...
  "settings.openchamber.visual.field.arrowKeyPromptHistoryAria": "As setas lembram mensagens anteriores",
  "settings.openchamber.visual.field.arrowKeyPromptHistory": "As setas lembram mensagens anteriores",
  "settings.openchamber.visual.field.arrowKeyPromptHistoryHint": "Quando desativado, as setas movem o cursor normalmente, em vez de lembrar mensagens anteriores.",
  ...
  "settings.openchamber.sidebar.title": "Barra lateral",
  "settings.openchamber.sidebar.tooltip": "Como a barra lateral de sessões se comporta depois de uma ação.",
  "settings.openchamber.sidebar.field.hideHeaderNewSession": "Ocultar o botão Nova sessão do cabeçalho",
  "settings.openchamber.sidebar.field.hideHeaderNewSessionAria": "Ocultar o botão Nova sessão do cabeçalho da barra lateral",
  "settings.openchamber.sidebar.field.hideHeaderNewSessionHint": "Oculta o botão global Nova sessão. Novas sessões passam a ser iniciadas pelo cabeçalho do projeto ou pelo menu dele.",
  "settings.openchamber.sidebar.field.actionsAlwaysVisible": "Mostrar sempre os ícones de ação da barra lateral",
  "settings.openchamber.sidebar.field.actionsAlwaysVisibleAria": "Mostrar sempre os ícones de ação da barra lateral",
  "settings.openchamber.sidebar.field.actionsAlwaysVisibleHint": "Mostra os ícones de ação de projetos e grupos em tom suave, em vez de revelá-los ao passar o mouse.",
