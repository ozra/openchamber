...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': '向上捲動聊天記錄',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': '向下捲動聊天記錄',
  ...
  'settings.openchamber.visual.field.arrowKeyPromptHistoryAria': '方向鍵回想先前的輸入',
  'settings.openchamber.visual.field.arrowKeyPromptHistory': '方向鍵回想先前的輸入',
  'settings.openchamber.visual.field.arrowKeyPromptHistoryHint': '關閉後，方向鍵不會回想先前的輸入，而是像平常一樣移動游標。',
  ...
  'settings.openchamber.sidebar.title': '側邊欄',
  'settings.openchamber.sidebar.tooltip': '執行操作後，工作階段側邊欄的行為。',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': '隱藏頂端的「新工作階段」按鈕',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': '隱藏側邊欄頂端的「新工作階段」按鈕',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': '隱藏全域的「新工作階段」按鈕。之後改從專案標題或其選單開始新工作階段。',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': '一律顯示側邊欄操作圖示',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': '一律顯示側邊欄操作圖示',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': '懸停時不再隱藏，而是以柔和的色調一律顯示專案與群組的操作圖示。',
