...
export const dict: Record<I18nKey, string> = {
  ...
  'quota.pace.aria.onPace': '已使用 {used}%，与流逝时间保持同步',
  'quota.pace.aria.aheadOne': '已使用 {used}%，比流逝时间快 1 个百分点',
  'quota.pace.aria.aheadMany': '已使用 {used}%，比流逝时间快 {delta} 个百分点',
  'quota.pace.aria.behindOne': '已使用 {used}%，比流逝时间慢 1 个百分点',
  'quota.pace.aria.behindMany': '已使用 {used}%，比流逝时间慢 {delta} 个百分点',
