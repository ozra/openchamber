...
export const settingsDict = {
  ...
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_up.label': 'Scroll chat history up',
  'settings.openchamber.keyboardShortcuts.action.scroll_chat_history_down.label': 'Scroll chat history down',
  ...
  'settings.openchamber.visual.field.arrowKeyPromptHistoryAria': 'Arrow keys recall previous prompts',
  'settings.openchamber.visual.field.arrowKeyPromptHistory': 'Arrow Keys Recall Previous Prompts',
  'settings.openchamber.visual.field.arrowKeyPromptHistoryHint': 'When off, the up and down arrow keys move the cursor as usual instead of recalling previous prompts.',
  ...
  'settings.openchamber.sidebar.title': 'Sidebar',
  'settings.openchamber.sidebar.tooltip': 'How the sessions sidebar behaves after you act.',
  'settings.openchamber.sidebar.field.hideHeaderNewSession': 'Hide the header New session button',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionAria': 'Hide the New session button in the sidebar header',
  'settings.openchamber.sidebar.field.hideHeaderNewSessionHint': 'Hides the global New session button. New sessions are then started from the project heading or its menu.',
  'settings.openchamber.sidebar.field.actionsAlwaysVisible': 'Always show sidebar action icons',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleAria': 'Always show sidebar action icons',
  'settings.openchamber.sidebar.field.actionsAlwaysVisibleHint': 'Shows project and group action icons at rest in a muted tone instead of revealing them on hover.',
