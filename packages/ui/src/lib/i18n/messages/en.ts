...
export const dict = {
  ...
  'quota.pace.aria.onPace': '{used} percent used, on pace with elapsed time',
  'quota.pace.aria.aheadOne': '{used} percent used, 1 percentage point ahead of elapsed time',
  'quota.pace.aria.aheadMany': '{used} percent used, {delta} percentage points ahead of elapsed time',
  'quota.pace.aria.behindOne': '{used} percent used, 1 percentage point behind elapsed time',
  'quota.pace.aria.behindMany': '{used} percent used, {delta} percentage points behind elapsed time',
