...
export const dict: Record<I18nKey, string> = {
  ...
  'quota.pace.aria.onPace': '已使用 {used}%，與流逝時間保持同步',
  'quota.pace.aria.aheadOne': '已使用 {used}%，比流逝時間快 1 個百分點',
  'quota.pace.aria.aheadMany': '已使用 {used}%，比流逝時間快 {delta} 個百分點',
  'quota.pace.aria.behindOne': '已使用 {used}%，比流逝時間慢 1 個百分點',
  'quota.pace.aria.behindMany': '已使用 {used}%，比流逝時間慢 {delta} 個百分點',
