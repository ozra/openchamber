...
export const SETTINGS_REGISTRY = {
  ...
  sidebarKeepOpen: field({ scope: 'profile', parse: parseBoolean, ui: uiStore('sidebarKeepOpen', (v) => useUIStore.getState().setSidebarKeepOpen(v)) }),
  sidebarHideHeaderNewSession: field({ scope: 'profile', parse: parseBoolean, ui: uiStore('sidebarHideHeaderNewSession', (v) => useUIStore.getState().setSidebarHideHeaderNewSession(v)) }),
  sidebarActionsAlwaysVisible: field({ scope: 'profile', parse: parseBoolean, ui: uiStore('sidebarActionsAlwaysVisible', (v) => useUIStore.getState().setSidebarActionsAlwaysVisible(v)) }),
  ...
  arrowKeyPromptHistoryEnabled: field({ scope: 'profile', parse: parseBoolean, ui: uiStore('arrowKeyPromptHistoryEnabled', (v) => useUIStore.getState().setArrowKeyPromptHistoryEnabled(v)) }),
