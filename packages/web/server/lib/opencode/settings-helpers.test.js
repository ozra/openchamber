...
describe('settings registry gate', () => {
  ...
  const validValues = {
    ...
    sidebarKeepOpen: true, sidebarHideHeaderNewSession: true, sidebarActionsAlwaysVisible: true,
    ...
    allowPromptingSubagentSessions: true, inputSpellcheckEnabled: true, arrowKeyPromptHistoryEnabled: true,
    enterToSend: true, enterToSendConfigured: true, persistChatDraft: true,
